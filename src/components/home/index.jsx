...
export function Home() {
  ...
  const iconController = "https://cdn-icons-png.flaticon.com/512/686/686589.png";
      ...
      <main className="main-area">
        ...
        <header className="topbar">
          ...
          <button
            ...
            onClick={() => navigate("/ConviteDuelo")}
            title="Duelos"
          >
            <img src={iconController} alt="Duelo" className="controller-icon" />
          </button>
